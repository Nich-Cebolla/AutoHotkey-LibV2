...
Accessing a subcapture group by name should be a more expensive operation compared to accessing
a subcapture group by number. In this example I have removed all named subpatterns, and shortened
the names of the callouts.

I condensed other parts of the script to go along with the aesthetic.

The results were much better than I expected. I was thinking maybe a 5-10% performance gain, but
this resulted in a whopping 30% performance gain. You can repeat the tests with file
re\test\test-performance.ahk.
