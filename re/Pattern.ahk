...
class Pattern {
    ...
    static Xml := '(<(?:[^><]++|(?-1))*/>)'
    static Xml2 := '(?(DEFINE)(?<xml>(<(?:[^><]++|(?&xml))*/>))<{}[^><]*?(?&xml)?[^><]*?/>'
    ...
    /**
     * Matches any valid xml element name, e.g. the name that comes after the < symbol in an xml / html
     * document. <div> <p> <table>.
     */
    static XmlElementName := ('(?:[\w_:]|[\x{C0}-\x{D6}]|[\x{D8}-\x{F6}]|[\x{F8}-\x{2FF}]|'
    '[\x{370}-\x{37D}]|[\x{37F}-\x{1FFF}]|[\x{200C}-\x{200D}]|[\x{2070}-\x{218F}]|[\x{2C00}-\x{2FEF}]|'
    '[\x{3001}-\x{D7FF}]|[\x{F900}-\x{FDCF}]|[\x{FDF0}-\x{FFFD}]|[\x{10000}-\x{EFFFF}])(?:[\w_:]|'
    ...
    '[\x{FDF0}-\x{FFFD}]|[\x{10000}-\x{EFFFF}]|[-.\d]|\x{B7}|[\x{0300}-\x{036F}]|[\x{203F}-\x{2040}])*')


    /**
     * See: {@link https://gist.github.com/Nich-Cebolla/c1fb28eb7de1e3728011a7504f451d2e}
     */
    static password := ('(?<=^|\s)(?:(?:[a-oq-z]|p(?![aA][sS]{2}[wW][oO][rR][dD]))+(?:(?:[A-OQ-Z]|P'
    '(?![aA][sS]{2}[wW][oO][rR][dD]))(?:[a-oq-zA-OQ-Z]|[pP](?![aA][sS]{2}[wW][oO][rR][dD]))*[-~!@#$'
    '%^&*_+=``|\(){}[\]:;"`'<>,.?/0-9]|[-~!@#$%^&*_+=``|\(){}[\]:;"`'<>,.?/](?:[-~!@#$%^&*_+=``|\()'
    '{}[\]:;"`'<>,.?/a-oq-z]|p(?![aA][sS]{2}[wW][oO][rR][dD]))*(?:[A-OQ-Z0-9]|P(?![aA][sS]{2}[wW][o'
    'O][rR][dD]))|[0-9](?:[0-9a-oq-z]|p(?![aA][sS]{2}[wW][oO][rR][dD]))*(?:[-~!@#$%^&*_+=``|\(){}[\'
    ']:;"`'<>,.?/A-OQ-Z]|P(?![aA][sS]{2}[wW][oO][rR][dD])))|(?:[A-OQ-Z]|P(?![aA][sS]{2}[wW][oO][rR]'
    '[dD]))+(?:(?:[a-oq-z]|p(?![aA][sS]{2}[wW][oO][rR][dD]))(?:[a-oq-zA-OQ-Z]|[pP](?![aA][sS]{2}[wW'
    '][oO][rR][dD]))*[-~!@#$%^&*_+=``|\(){}[\]:;"`'<>,.?/0-9]|[-~!@#$%^&*_+=``|\(){}[\]:;"`'<>,.?/]'
    '(?:[-~!@#$%^&*_+=``|\(){}[\]:;"`'<>,.?/A-OQ-Z]|P(?![aA][sS]{2}[wW][oO][rR][dD]))*(?:[a-oq-z0-9'
    ']|p(?![aA][sS]{2}[wW][oO][rR][dD]))|[0-9](?:[0-9A-OQ-Z]|P(?![aA][sS]{2}[wW][oO][rR][dD]))*(?:['
    '-~!@#$%^&*_+=``|\(){}[\]:;"`'<>,.?/a-oq-z]|p(?![aA][sS]{2}[wW][oO][rR][dD])))|[-~!@#$%^&*_+=``'
    '|\(){}[\]:;"`'<>,.?/]+(?:(?:[a-oq-z]|p(?![aA][sS]{2}[wW][oO][rR][dD]))(?:[-~!@#$%^&*_+=``|\(){'
    '}[\]:;"`'<>,.?/a-oq-z]|p(?![aA][sS]{2}[wW][oO][rR][dD]))*(?:[A-OQ-Z0-9]|P(?![aA][sS]{2}[wW][oO'
    '][rR][dD]))|(?:[A-OQ-Z]|P(?![aA][sS]{2}[wW][oO][rR][dD]))(?:[-~!@#$%^&*_+=``|\(){}[\]:;"`'<>,.'
    '?/A-OQ-Z]|P(?![aA][sS]{2}[wW][oO][rR][dD]))*(?:[a-oq-z0-9]|p(?![aA][sS]{2}[wW][oO][rR][dD]))|['
    '0-9][-~!@#$%^&*_+=``|\(){}[\]:;"`'<>,.?/0-9]*(?:[a-oq-zA-OQ-Z]|[pP](?![aA][sS]{2}[wW][oO][rR]['
    'dD])))|[0-9]+(?:(?:[a-oq-z]|p(?![aA][sS]{2}[wW][oO][rR][dD]))(?:[0-9a-oq-z]|p(?![aA][sS]{2}[wW'
    '][oO][rR][dD]))*(?:[-~!@#$%^&*_+=``|\(){}[\]:;"`'<>,.?/A-OQ-Z]|P(?![aA][sS]{2}[wW][oO][rR][dD]'
    '))|(?:[A-OQ-Z]|P(?![aA][sS]{2}[wW][oO][rR][dD]))(?:[0-9A-OQ-Z]|P(?![aA][sS]{2}[wW][oO][rR][dD]'
    '))*(?:[-~!@#$%^&*_+=``|\(){}[\]:;"`'<>,.?/a-oq-z]|p(?![aA][sS]{2}[wW][oO][rR][dD]))|[-~!@#$%^&'
    '*_+=``|\(){}[\]:;"`'<>,.?/][-~!@#$%^&*_+=``|\(){}[\]:;"`'<>,.?/0-9]*(?:[a-oq-zA-OQ-Z]|[pP](?!['
    'aA][sS]{2}[wW][oO][rR][dD]))))(?:[-~!@#$%^&*_+=``|\(){}[\]:;"`'<>,.?/a-oq-zA-OQ-Z0-9]+|[pP](?!'
    '[aA][sS]{2}[wW][oO][rR][dD]))*(?=\s|$)')
}
